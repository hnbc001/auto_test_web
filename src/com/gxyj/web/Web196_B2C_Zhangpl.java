...
public class Web196_B2C_Zhangpl extends TestBase {

	@Test
	public void errPhone() {
		...
		try{	
			...
			locator.sendKeys("结算页_B2C", "收货手机", "1111");
			locator.clickByXml("结算页_B2C", "保存地址");
			text=locator.getText("提示信息_B2C", "提示内容");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
			Reporter.log("【fail】Web196_B2C:结算页填写错误手机号码提示失败");
		}
		
		checkPoint.equals(text, "请输入正确的手机号码", "【fail】Web196_B2C:结算页填写错误手机号码提示失败");
		checkPoint.result("【pass】Web196_B2C:结算页填写错误手机号码提示成功");
	}
}
