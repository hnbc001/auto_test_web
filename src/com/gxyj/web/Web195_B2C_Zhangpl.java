...
public class Web195_B2C_Zhangpl extends TestBase {
	...
	public void noPhone() {
		...
		try{		
			...
			e.printStackTrace();
			Reporter.log("【fail】Web195_B2C:结算页未填写手机号码提示失败");
		}
		
		checkPoint.equals(text, "请输入手机号码", "【fail】Web195_B2C:结算页未填写手机号码提示失败");
		checkPoint.result("【pass】Web195_B2C:结算页未填写手机号码提示成功");
	}
}
